...
namespace EA::discovery {
    ...
    void DiscoveryStateMachine::on_apply(braft::Iterator &iter) {
        for (; iter.valid(); iter.next()) {
            ...
            TLOG_INFO("on apply, term:{}, index:{}, request op_type:{}",
                      ...
                      EA::discovery::OpType_Name(request.op_type()));
    ...
    void DiscoveryStateMachine::on_snapshot_save(braft::SnapshotWriter *writer, braft::Closure *done) {
    ...
    void DiscoveryStateMachine::save_snapshot(braft::Closure *done,
