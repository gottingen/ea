...
namespace EA::discovery {
    ...
    public:
        ...
        /// \param request
        /// \param done
        void create_namespace(const EA::discovery::DiscoveryManagerRequest &request, braft::Closure *done);
        ...
        /// \param request
        /// \param done
        void drop_namespace(const EA::discovery::DiscoveryManagerRequest &request, braft::Closure *done);
        ...
        /// \param request
        /// \param done
        void modify_namespace(const EA::discovery::DiscoveryManagerRequest &request, braft::Closure *done);
        ...
        /// \return
        int get_namespace_info(const int64_t &namespace_id, EA::discovery::NameSpaceInfo &namespace_info);
    ...
    private:
        ...
        /// \param namespace_info
        void set_namespace_info(const EA::discovery::NameSpaceInfo &namespace_info);
    ...
    private:
        ...
        std::unordered_map<int64_t, EA::discovery::NameSpaceInfo> _namespace_info_map;
    ...
    inline void NamespaceManager::set_namespace_info(const EA::discovery::NameSpaceInfo &namespace_info) {
        BAIDU_SCOPED_LOCK(_namespace_mutex);
    ...
    inline int NamespaceManager::get_namespace_info(const int64_t &namespace_id, EA::discovery::NameSpaceInfo &namespace_info) {
        BAIDU_SCOPED_LOCK(_namespace_mutex);
        if (_namespace_info_map.find(namespace_id) == _namespace_info_map.end()) {
            return -1;
        }
