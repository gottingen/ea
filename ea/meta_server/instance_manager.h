...
#ifndef EA_META_SERVER_INSTANCE_MANAGER_H_
#define EA_META_SERVER_INSTANCE_MANAGER_H_
...
namespace EA::servlet {
    ...
    public:
        ...
        /// \param request
        /// \param done
        void add_instance(const EA::servlet::MetaManagerRequest &request, braft::Closure *done);

        ///
        /// \param request
        /// \param done
        void drop_instance(const EA::servlet::MetaManagerRequest &request, braft::Closure *done);

        ///
        /// \param request
        /// \param done
        void update_instance(const EA::servlet::MetaManagerRequest &request, braft::Closure *done);
    ...
    private:
        ...
        void set_instance_info(const EA::servlet::ServletInstance &instance_info);
    ...
    private:
        ...
        turbo::flat_hash_map<std::string, EA::servlet::ServletInstance>       _instance_info;
    ...
    inline std::string InstanceManager::construct_instance_key(const std::string &address) {
        std::string instance_key = MetaConstants::DISCOVERY_IDENTIFY
...
#endif  // EA_META_SERVER_INSTANCE_MANAGER_H_
