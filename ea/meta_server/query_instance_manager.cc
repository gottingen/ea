...
namespace EA::servlet {
    ...
    void QueryInstanceManager::query_instance(const EA::servlet::QueryRequest *request, EA::servlet::QueryResponse *response) {
    ...
    void QueryInstanceManager::instance_info_to_query(const EA::servlet::ServletInstance &sinstance, EA::servlet::QueryInstance &ins) {
