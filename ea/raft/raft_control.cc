...
#include <algorithm>
#include "ea/raft/update_region_status.h"
...
namespace EA {
    ...
    public:
        ...
        virtual void Run() {
            ...
            if (status().ok()) {
                ...
                _response->set_errcode(proto::SUCCESS);
            } else {
                TLOG_WARN("raft control failed, type:{}, region_id:{},"
                           ...
                           log_id);
                _response->set_errcode(proto::INTERNAL_ERROR);
    ...
    private:
        ...
        const proto::RaftControlRequest *_request;
        proto::RaftControlResponse *_response;
